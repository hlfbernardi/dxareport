		...
		<div class="jumbotron">
			<form class="formulario" method="post" id="formulario" action="zscore.php">
				...
				<fieldset class="form-group">
					...
					<div class="form-group row">
						<label for="zsspine" class="col-sm-2 col-form-label">Z-score Lumbar</label>
						<div class="col-sm-4">
							<input pattern="^-?[0-9][0-9\.]+$" required title="Use this dotted decimal number format:-1.0" type="text" class="form-control" id="zslomb" name="zslomb" step="0.1" min="-100" max="100" size="4" maxlength="4" placeholder="ex: -2.3">
						</div>
					</div>
				...
				<fieldset class="form-group">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<input type="text" pattern="^-?[0-9][0-9\.]+$" required title="Use this dotted decimal number format:-1.5" class="form-control" id="zscolo" name="zscolo" step="0.1" min="-100" max="100" size="4" maxlength="4" placeholder="ex: -2.8">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<input type="text" pattern="^-?[0-9][0-9\.]+$" required title="Use this dotted decimal number format:-2.0" class="form-control" id="zsft" name="zsft" step="0.1" min="-100" max="100" size="4" maxlength="4" placeholder="ex: -2.8">
						</div>
					</div>
					<div class="form-group row">
