...
<script type="text/javascript" src="//cdn.popcash.net/pop.js"></script>
		...
		<div class="jumbotron">
			<form class="formulario" method="post" id="formulario" action="wrist.php">
				...
				<fieldset class="form-group">
					...
					<div class="form-group row">
						<label for="tsantebraco" class="col-sm-2 col-form-label">T-score Forearm</label>
						<div class="col-sm-4">
							<input pattern="^-?[0-9][0-9\.]+$" required title="Use this dotted decimal number format:-1.0" type="text" class="form-control" id="tsantebraco" name="tsantebraco" step="0.1" min="-100" max="100" size="4" maxlength="4" placeholder="ex: -1.8">
						</div>
					</div>

					<div class="form-group row">
						<label for="dmoantebraco" class="col-sm-2 col-form-label">BMD Forearm</label>
						<div class="col-sm-4">
							<input pattern="^-?[0-9][0-9\.]+$" required title="Use this format: 0.861" type="text" class="form-control" id="dmoantebraco" name="dmoantebraco" step="0.001" min="-100" max="100" size="5" maxlength="5" placeholder="ex: 0.983">
						</div>
					</div>
