...
<body>
	<div class="container">
		...
		<h3>Results:</h3>
		<div class="coluna">
			<p> <b>LUMBAR SPINE :</b><br>
				The BMD measured in the <?= $slombar ?> region is: <?= $dmolomb ?> g/cm<sup>2</sup><br>
				Z-score: <?= $zslomb ?>
				The results on this region : <b><?= $resultlomb ?></b> </p>
		</div>

		<div class="femur">
			<p><b><?= $side ?> FEMUR :</b><br>
				The BMD measured at the femoral neck is : <?= $dmocolo ?> g/cm<sup>2</sup> <br>
				Z-score: <?= $zscolo ?> desvios-padrão em relação a população referência com a mesma idade. </br>
				The BMD measured at the total proximal femur is: <?= $dmoft ?> g/cm<sup>2</sup><br>
				Z-score: <?= $zsft ?>
				The results on this region : <b><?= $resultfemur ?></b> </p>
		</div>
